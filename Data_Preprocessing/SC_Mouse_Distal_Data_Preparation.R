...
meta <- fread("Mouse_Distal_Metadata.csv")
...
write.table(x = meta, 
            file = "Mouse_Distal_Metadata_soup.csv",
            sep = ",",
            row.names = FALSE)
...
saveRDS(All.merged, file = "20220810_Mouse_Distal.rds")

## Load RDS ##

All.merged <- readRDS(file = "20220810_Mouse_Distal.rds", refhook = NULL)
...
ggsave(filename = "unfiltered_MT.pdf", plot = unfiltered_MT, width = 12, height = 9, dpi = 600)
...
ggsave(filename = "unfiltered_nFeature.pdf", plot = unfiltered_nFeature, width = 12, height = 9, dpi = 600)
...
ggsave(filename = "unfiltered_nCount.pdf", plot = unfiltered_nCount, width = 12, height = 9, dpi = 600)
...
saveRDS(Filtered_Cells, file = "20220810_Filtered_Cells.rds")

## Load RDS ##

Filtered_Cells <- readRDS(file = "20220810_Filtered_Cells.rds", refhook = NULL)
...
mycol = coalesce(Filtered_Cells@meta.data$DF.classifications_0.25_0.005_191 , 
                 Filtered_Cells@meta.data$DF.classifications_0.25_0.3_101  ,
                 Filtered_Cells@meta.data$DF.classifications_0.25_0.3_133)

Filtered_Cells@meta.data$Doublet = mycol

# Doublet Dataframe #
pANN <- coalesce(Filtered_Cells@meta.data$pANN_0.25_0.005_191, 
                 Filtered_Cells@meta.data$pANN_0.25_0.3_101,
                 Filtered_Cells@meta.data$pANN_0.25_0.3_133)
...
All_Doublet <- DimPlot(object = Filtered_Cells, 
        reduction = 'umap', 
        group.by = "Doublet",
...
ggsave(filename = "All_Doublet_umap.pdf", plot = All_Doublet, width = 22, height = 17, dpi = 600)
