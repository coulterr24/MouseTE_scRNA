...
ggsave(filename = "FIG6e_stacked_vln.pdf", plot = stack_vln, width = 18, height = 12, dpi = 600)
...
Krt5_dp <- DotPlot(object = Epi_Named,                    # Seurat object
...
ggsave(filename = "Krt5_dp.pdf", plot = Krt5_dp, width = 1.89*8, height = 3.06*8, dpi = 600)
